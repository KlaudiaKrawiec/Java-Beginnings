...
int i = 7;
System.out.println("Powieœæ \"Wojna i pokój\" Lwa To³stoja");
...
System.out.println("7 * (2 do potêgi 3) = " + (7 << 3) );
System.out.println("Czêœæ ca³kowita 2.56 wynosi " + (int) 2.56);
...
System.out.println("Wartoœæ i=" + i + ", a ++i=" + (++i));
System.out.println("Gdy teraz wykonamy operacjê i*=9 to i=" + (i*=9));
}
}